...
import com.example.webapp.repository.TutorialRepository;
...
public class TutorialController {
  ...
  public String editTutorial(@PathVariable("id") ObjectId id, Model model, RedirectAttributes redirectAttributes) {
    try {
      Tutorial tutorial = tutorialRepository.findById(id.toString()).get();
  ...
  public String updateTutorialPublishedStatus(@PathVariable("id") String id, @PathVariable("status") boolean published,
